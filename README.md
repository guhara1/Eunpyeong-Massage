...
content/
  ...
  stations.py       # 지하철역별: 허브 + 12개 역 (3·6호선·경의중앙선)
...
- 지역은 대표 동 11개만 (녹번·불광·갈현·구산·대조·응암·역촌·신사·증산·수색·진관) — 숫자 행정동 페이지 없음
  - 불광1·2동→불광동, 갈현1·2동→갈현동, 응암1·2·3동→응암동, 신사1·2동→신사동으로 통합
- 역은 역 1개당 페이지 1개 — 환승역(불광·연신내·디지털미디어시티)도 URL 하나, 출구별 페이지 없음
